...
Return a JSON object with the following structure, where each field contains either the extracted value or "N/A":
{
  "first_name": "string",
  "middle_name": "string",
  "last_name": "string",
  ...
  "address": "string",
  "gross_wage_per_month": "string",
  "tax": "string",
  "net_wage_per_month": "string",
  "super_per_month": "string",
  "rental_property_income": "string",
  "dividend_income": "string",
  "interest_income": "string",
  "allowance_income": "string",
  "other_investment_income": "string",
  "grocery_expenses_per_month": "string",
  "education_expenses": "string",
  "mortgage_expenses": "string",
  "travel_expenses": "string",
  "other_expenses": "string",
  "main_residence_address": "string",
  "main_residence_purchase_price": "string",
  "number_of_investment_properties": "string",
  "investment_property_purchase_price": "string",
  "car_model_make": "string",
  "car_purchase_price": "string",
  "share_portfolio_market_value": "string",
  "mortgage_outstanding": "string",
  "credit_card_limit": "string",
  "personal_loan_outstanding": "string",
  "car_loan_outstanding": "string",
  "other_loans_outstanding": "string",
  "number_of_dependents": "string",
  "age_of_dependents": "string",
  "hecs_fees_outstanding": "string",
  "name_of_last_employer": "string",
  "referee_name": "string",
